...
import ij.*;
import macro.Program;
import plugin.MacroInstaller;
import plugin.RectToolOptions;
import plugin.frame.*;
import plugin.tool.MacroToolRunner;
import plugin.tool.PlugInTool;
	...
	*/
	...
	private boolean installBuiltinTool(String label) {
		...
		if (label.startsWith("Arrow")) {
			...
			tool = new plugin.tool.RoiRotationTool();
			if (tool!=null) tool.run("");
