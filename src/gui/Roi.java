package gui;
import ij.*;
import io.RoiDecoder;
import macro.Interpreter;
import measure.*;
import plugin.*;
import plugin.filter.Analyzer;
import plugin.filter.ThresholdToSelection;
import plugin.frame.Recorder;
import plugin.frame.RoiManager;
import process.*;
...
public class Roi extends Object implements Cloneable, java.io.Serializable, Iterable<Point> {
	...
	*/
	...
	/** Returns the outline of this selection as a Polygon.
		@see process.ImageProcessor#setRoi
		@see process.ImageProcessor#drawPolygon
		@see process.ImageProcessor#fillPolygon
	*/
	...
	*/
	...
	/** Draws the selection outline on the specified ImageProcessor.
		@see process.ImageProcessor#setColor
		@see process.ImageProcessor#setLineWidth
	*/
	...
	*/
	 ...
	 * @see #getStrokeColor
	 * @see #setStrokeWidth
	 * @see ij.ImagePlus#setOverlay(gui.Overlay)
	 */
