...
import plugin.Binner;
import plugin.filter.GaussianBlur;
import process.AutoThresholder.Method;
import util.Java2;
import util.Tools;
import ij.Prefs;
...
public abstract class ImageProcessor implements Cloneable {
	...
	*/
	 ...
	 * @see gui.Toolbar#setForegroundColor(Color)
	 * @see gui.Toolbar#setForegroundValue(double)
	*/
	 ...
	 * as the fill/draw color.
	 * @see gui.Toolbar#setBackgroundColor(Color)
	 * @see gui.Toolbar#setBackgroundValue(double)
	*/
	...
	*/
	...
	/** Set a lookup table used by getPixelValue(), getLine() and
		...
		@see measure.Calibration#setCTable
	*/
	...
	*/
	...
	/** Returns a new ImageProcessor containing a scaled copy of this image or ROI.
		@see process.ImageProcessor#setInterpolate
	*/
	...
	*/
	...
	public void applyMacro(String macro) {
		plugin.filter.ImageMath.applyMacro(this, macro, false);
	}
